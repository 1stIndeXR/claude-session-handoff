...
- `handoffs/latest.md` — always-current handoff (sections 1–8)
...
3. **Restore:** put [`core/session-resume.md`](../../core/session-resume.md) the same way, or simply tell the agent: *"Read `handoffs/latest.md` and resume from section 8."*
